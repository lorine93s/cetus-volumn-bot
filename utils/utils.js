...
exports.sleep = exports.saveNewFile = exports.saveDataToFile = exports.randVal = exports.retrieveEnvVariable = void 0;
...
const saveNewFile = (newData, filePath = "data.json") => {
    try {
        // Write the updated data back to the file
        fs_1.default.writeFileSync(filePath, JSON.stringify(newData, null, 2));
    }
